    ...
    <main className="min-h-screen bg-white dark:bg-black text-black dark:text-white">
      ...
      <section className="relative h-[60vh] flex items-center overflow-hidden border-b border-gray-100 dark:border-gray-900">
        ...
        <div className="relative z-10 max-w-4xl px-8">
          <h2 className="text-blue-600 font-bold tracking-widest text-sm mb-4 uppercase">Infrastructure nodes</h2>
      ...
      <section className="py-24">
        <div className="container mx-auto px-8">
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            <div>
              <h2 className="text-blue-600 font-bold text-sm tracking-widest mb-6 uppercase">Network foundation</h2>
      ...
      <section className="py-24 bg-gray-50 dark:bg-[#050505] border-y border-gray-100 dark:border-gray-900">
        <div className="container mx-auto px-8">
          <div className="max-w-3xl mb-16">
            <h2 className="text-blue-600 font-bold text-sm tracking-widest mb-4 uppercase">Deployment items</h2>
